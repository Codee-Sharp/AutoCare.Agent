...
class SessionContext(StrictModel):
    contract_version: Literal["1.0"] = "1.0"
    sessao_hash: str
    resumo_sanitizado: str = Field(default="", max_length=1000)
    ultima_intencao: Intent = Intent.UNKNOWN
    acoes_pendentes: list[ProposedAction] = Field(default_factory=list, max_length=10)
